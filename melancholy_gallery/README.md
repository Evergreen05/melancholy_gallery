...
访问 `/admin/` 管理面板，支持以下功能：

### 用户管理
| 功能 | 说明 |
|------|------|
| 用户列表 | 显示用户名、邮箱、图画数、视频数、粉丝数 |
| 批量禁用/启用 | 选中用户后一键操作 |
| 批量禁止/允许上传 | 控制用户上传权限 |
| 批量禁止/允许评论 | 控制用户评论权限 |
| 搜索 | 支持按用户名和邮箱搜索 |
...
| 功能 | 说明 |
|------|------|
| 图画管理 | 列表显示预览图、点赞数、评论数，内联显示评论 |
| 视频管理 | 列表显示封面预览、点赞数、评论数 |
| 评论管理 | 支持按内容和作者搜索 |
| 批量删除 | 图画、视频、评论均支持批量删除（自动级联删除关联数据） |

### 私信管理
| 功能 | 说明 |
|------|------|
| 私信列表 | 显示发送者、接收者、内容、已读状态 |
| 批量标记已读/未读 | 一键操作 |
| 搜索 | 支持按用户名和内容搜索 |
